    ...
    public static void main(String[] args) { // the start button of the program, everything runs inside this bracket
        ...
        switch (roleCode) {
            ...
            case 4:
                ...
                break;
            default:
                position = "Unknown"; // in case user enters invalid number
        }
        ...
        System.out.println("Position:          " + position); // Display role
